...
export class BookingResolverBase {
  ...
  @graphql.ResolveField(() => Desk, {
    nullable: true,
    name: "desk",
  })
  async getDesk(@graphql.Parent() parent: Booking): Promise<Desk | null> {
    const result = await this.service.getDesk(parent.id);
